...
MetaModel::~MetaModel()
	{
		...
		for ( uint32 i = 0 ; i < m_vAnimSets.size() ; i++ )
		{
...
// values.
// ------------------------------------------------------------------------
void KeyFrameTimeSlideToZero( CLTAKeyFrame & kf )
{
...
// ------------------------------------------------------------------------
static 
void KeyFrameFromPN( CLTANode *kf , CLTAKeyFrame & KF, CLTATranslStatus & status  )
{
